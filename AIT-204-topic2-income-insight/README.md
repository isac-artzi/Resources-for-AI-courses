# Income-Insight — AIT-204 Three-Cloud Product (Topic 2)

> **Product 2 of 7.** The same three-cloud architecture as Topic 1
...
> binary classification. Build it after Topic 1's *Regress-It*; the deploy steps
...
| Aspect | Topic 1 — Regress-It | Topic 2 — Income-Insight |
|--------|----------------------|--------------------------|
...
```bash
cd AIT-204-topic2-income-insight
