...
concerns across the three clouds. This is Topic 2 "Income-Insight": tabular
binary classification with a PyTorch MLP + sklearn preprocessing pipeline.
"""
...
app = FastAPI(
    ...
    description="Tabular MLP classifier for the AIT-204 three-cloud stack (Topic 2).",
    version="1.0.0",
)
