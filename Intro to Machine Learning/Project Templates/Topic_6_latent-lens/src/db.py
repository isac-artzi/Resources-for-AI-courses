...
CRUD on single tables. We read the table into pandas and do everything else
(scaling, clustering, PCA, association rules) there.

This topic has a single raw table, ``shoppers``, plus a small ``provenance``
...
KNOWN_TABLES = {"shoppers", "provenance"}
