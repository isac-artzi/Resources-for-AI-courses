# Regress-It — AIT-204 Three-Cloud Reference Product

> **Product 1 of 7.** A working, forkable template for the required three-cloud
> architecture: **Streamlit (UI) ⇄ FastAPI (Model API) ⇄ Supabase (Data)**.
> Fork it, wire up your own accounts, and reuse the exact same pattern for
> Topics 2–7.
...
> Replace the placeholders above with your real URLs. The syllabus requires all
> three to be listed at the top of your product README.
...
```bash
cd AIT-204-3-cloud-architecture
...
Supabase stays the single source of truth. The mapping for all 7 products is in
the final section of [`TUTORIAL.md`](./TUTORIAL.md).
